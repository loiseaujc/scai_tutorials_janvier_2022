...
\begin{frame}{Ordinary least-squares}
  ...
  \begin{minipage}{.48\textwidth}
      \large
      \[
      \minimize_{a, b} \sum_{i=1}^N \left( y_i - a x_i - b)^2
      \]
  \end{minipage}%
  \hfill
  \begin{minipage}{.48\textwidth}
...
\begin{frame}{Low-rank approximation}
  Reconstructed image for different rank
\end{frame}
...
\begin{frame}{Low-rank approximation}
  Image with more fine scale details
\end{frame}
...
\begin{frame}
  Example for the Ginzburg Landau equation
\end{frame}
